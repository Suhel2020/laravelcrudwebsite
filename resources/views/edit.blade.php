    ...
    <div class="container">
        ...
        <form method="POST" action="/update/{{$posts->id}}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="fname" class="form-control" value={{$posts->post_fname}}>
            </div>
            <div class="mb-3">
                <label><b>Student Last Name:</b></label>
                <input type="text" name="lname" class="form-control" value={{$posts->post_lname}}>
            </div>
            <div class="mb-3">
                <label><b>Student Phone Number:</b></label>
                <input type="text" name="number" class="form-control" value={{$posts->post_number}}>
            </div>
